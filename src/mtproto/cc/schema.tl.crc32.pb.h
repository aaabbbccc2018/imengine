...
#ifndef PROTOBUF_schema_2etl_2ecrc32_2eproto__INCLUDED
#define PROTOBUF_schema_2etl_2ecrc32_2eproto__INCLUDED
...
enum TLConstructor {
  ...
  TLConstructor_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  TLConstructor_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool TLConstructor_IsValid(int value);
const TLConstructor TLConstructor_MIN = CRC32_langpack_getLanguagesLayer70;
const TLConstructor TLConstructor_MAX = CRC32_messageActionChatEditPhoto;
const int TLConstructor_ARRAYSIZE = TLConstructor_MAX + 1;

const ::google::protobuf::EnumDescriptor* TLConstructor_descriptor();
inline const ::std::string& TLConstructor_Name(TLConstructor value) {
  return ::google::protobuf::internal::NameOfEnum(
    TLConstructor_descriptor(), value);
}
inline bool TLConstructor_Parse(
    const ::std::string& name, TLConstructor* value) {
  return ::google::protobuf::internal::ParseNamedEnum<TLConstructor>(
    TLConstructor_descriptor(), name, value);
}
// ===================================================================
...
template <> struct is_proto_enum< ::mtproto::TLConstructor> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mtproto::TLConstructor>() {
  return ::mtproto::TLConstructor_descriptor();
}
...
#endif  // PROTOBUF_schema_2etl_2ecrc32_2eproto__INCLUDED
